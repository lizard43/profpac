...
1. Close the fixed-ROM question-response controller from slot selection through
   timeout/correctness feedback, score and bonus updates, and round transition.

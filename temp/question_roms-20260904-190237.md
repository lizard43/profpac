...
and completion words established by the `ppq1` family. The initializer layer
...
contract, extracts directly referenced counted prompts, and checks the
canonical symbolic initializer source:

...
MAIN_PROGRESSION_ACTIONS_POINTER:
        dw      MAIN_PROGRESSION_ACTIONS                                       ; $C002 configuration-1 return list
MAIN_CONTROL_ACTIONS_POINTER:
        dw      MAIN_CONTROL_ACTIONS                                           ; $C004 configuration-1 control list
ATTRACT_CHALLENGE_PROMPT_ACTIONS_POINTER:
        dw      ATTRACT_CHALLENGE_PROMPT_ACTIONS                               ; $C006 configuration-1 list
ATTRACT_DEMO_QUESTION_ACTIONS_POINTER:
        dw      ATTRACT_DEMO_QUESTION_ACTIONS                                  ; $C008 configuration-1 list
CREDIT_START_PROMPT_ACTIONS_POINTER:
        dw      CREDIT_START_PROMPT_ACTIONS                                    ; $C00A configuration-1 list
GAME_OVER_ACTIONS_POINTER:
        dw      GAME_OVER_ACTIONS                                              ; $C00C fixed result list
...
LC079:
        ...
        dw      MAIN_CONTROL_ACTIONS_PTR_ADDR                                   ; $C07B inline word
...
LC556:
        ...
        dw      PLAYER_ONE_SCORE_ADDR                                                           ; $C56D inline word
        ...
        dw      PLAYER_TWO_SCORE_ADDR                                                           ; $C58A inline word
...
LCBAA:
        ...
        dw      PLAYER_ONE_SCORE_ADDR                                                           ; $CBC2 inline word
...
LCBCB:
        ...
        dw      PLAYER_TWO_SCORE_ADDR                                                           ; $CBD7 inline word
...
TERSE_COLON_D036:
        ...
        dw      XT_LIT                  ; $D03D _LIT
        dw      PLAYER_ONE_SCORE_ADDR                ; $D03F inline word
        dw      NATIVE_CB66          ; $D041 NATIVE_CB66
        dw      XT_LIT                  ; $D043 _LIT
        dw      PLAYER_TWO_SCORE_ADDR                ; $D045 inline word
...
LD295:
        ...
        dw      GAME_OVER_ACTIONS_PTR_ADDR                                      ; $D297 inline word
...
LD341:
        ...
        dw      MAIN_PROGRESSION_PTR_ADDR                               ; $D365 inline word
...
LD43A:
        ...
        dw      CREDIT_COUNT_ADDR                                                           ; $D43C inline word
...
LD45C:
        ...
        dw      FREE_PLAY_FLAG_ADDR                                                           ; $D45E inline word
...
; Wait for a valid one-player/two-player start request, charge available
; credits, initialize both player records, and invoke the question executive.
; ( -- )
START_GAME_CONTROL_TASK:
...
LD51F:
        ...
        dw      FREE_PLAY_FLAG_ADDR                                                           ; $D527 inline word
        ...
        dw      CREDIT_COUNT_ADDR                                                           ; $D533 inline word
        dw      XT_SBbang                                                       ; $D535 execution token
LD537:
        dw      XT_LIT                                                          ; $D537 execution token
        dw      CREDIT_COUNT_ADDR                                                           ; $D539 inline word
...
LD58C:
        ...
        dw      PLAYER_ONE_SCORE_ADDR                                                           ; $D5AC inline word
        dw      $20AE                                                           ; $D5AE execution token
        dw      XT_LIT                                                          ; $D5B0 execution token
        dw      PLAYER_TWO_SCORE_ADDR                                                           ; $D5B2 inline word
...
DRAW_INITIALS_ENTRY_INSTRUCTIONS:
...
LD733:
        ...
        dw      XT_LIT                  ; $D738 _LIT
        dw      HIGH_SCORE_INITIALS_ADDR                ; $D73A inline word
        dw      XT_plus                 ; $D73C _plus
        dw      XT_RETURN               ; $D73E _RETURN
LOAD_HIGH_SCORE_INITIALS:
        rst     $08                             ; $D740 colon entry
        dw      HIGH_SCORE_INITIALS_ADDRESS     ; $D741 HIGH_SCORE_INITIALS_ADDRESS
        dw      XT_LIT                  ; $D743 _LIT
...
STORE_HIGH_SCORE_INITIALS:
        rst     $08                             ; $D752 colon entry
        dw      HIGH_SCORE_INITIALS_ADDRESS     ; $D753 HIGH_SCORE_INITIALS_ADDRESS
        dw      XT_LIT                  ; $D755 _LIT
...
LD774:
        ...
        dw      XT_LIT                  ; $D779 _LIT
        dw      HIGH_SCORE_TABLE_ADDR                ; $D77B inline word
        dw      XT_plus                 ; $D77D _plus
        dw      XT_RETURN               ; $D77F _RETURN
FETCH_HIGH_SCORE_ENTRY:
        rst     $08                             ; $D781 colon entry
        dw      HIGH_SCORE_ENTRY_ADDRESS     ; $D782 HIGH_SCORE_ENTRY_ADDRESS
        dw      XT_DUP                  ; $D784 _DUP
...
STORE_HIGH_SCORE_ENTRY:
        rst     $08                             ; $D790 colon entry
        dw      HIGH_SCORE_ENTRY_ADDRESS     ; $D791 HIGH_SCORE_ENTRY_ADDRESS
        dw      XT_DUP                  ; $D793 _DUP
        dw      XT_ROT                  ; $D795 _ROT
...
FETCH_PLAYER_ONE_SCORE:
        rst     $08                             ; $D7A1 colon entry
        dw      XT_LIT                  ; $D7A2 _LIT
        dw      PLAYER_ONE_SCORE_ADDR                ; $D7A4 inline word
        dw      XT_at                   ; $D7A6 _at
        dw      XT_LIT                  ; $D7A8 _LIT
        dw      PLAYER_ONE_SCORE_ADDR                ; $D7AA inline word
        dw      XT_2plus                ; $D7AC _2plus
        dw      XT_at                   ; $D7AE _at
        dw      XT_RETURN               ; $D7B0 _RETURN
FETCH_PLAYER_TWO_SCORE:
        rst     $08                             ; $D7B2 colon entry
        dw      XT_LIT                  ; $D7B3 _LIT
        dw      PLAYER_TWO_SCORE_ADDR                ; $D7B5 inline word
        dw      XT_at                   ; $D7B7 _at
        dw      XT_LIT                  ; $D7B9 _LIT
        dw      PLAYER_TWO_SCORE_ADDR                ; $D7BB inline word
        dw      XT_2plus                ; $D7BD _2plus
        dw      XT_at                   ; $D7BF _at
        dw      XT_RETURN               ; $D7C1 _RETURN
GET_INITIALS_CHARACTER:
        rst     $08                             ; $D7C3 colon entry
        dw      XT_LIT                  ; $D7C4 _LIT
        dw      $F6DA                ; $D7C6 inline word
        dw      XT_Bat                  ; $D7C8 _Bat
        dw      XT_RETURN               ; $D7CA _RETURN
PREPARE_INITIALS_BUFFER:
...
INITIALS_CURSOR_AT_LIMIT:
        rst     $08                             ; $D7EB colon entry
        dw      XT_LIT                  ; $D7EC _LIT
        dw      $F6D6                ; $D7EE inline word
        dw      XT_Bat                  ; $D7F0 _Bat
        dw      GET_INITIALS_CHARACTER     ; $D7F2 GET_INITIALS_CHARACTER
        dw      XT_equal                ; $D7F4 _equal
        dw      XT_LIT                  ; $D7F6 _LIT
        dw      $F6D5                ; $D7F8 inline word
        dw      XT_Bat                  ; $D7FA _Bat
        dw      GET_INITIALS_CHARACTER     ; $D7FC GET_INITIALS_CHARACTER
        dw      XT_equal                ; $D7FE _equal
        dw      XT_OR                   ; $D800 _OR
        dw      XT_RETURN               ; $D802 _RETURN
DRAW_INITIALS_CHARACTER:
...
INSERT_HIGH_SCORE_ENTRY:
        ...
        dw      XT_I                    ; $DA5F _I
        dw      FETCH_HIGH_SCORE_ENTRY     ; $DA61 FETCH_HIGH_SCORE_ENTRY
        ...
        dw      XT_DO                   ; $DA83 _DO
        dw      XT_I                    ; $DA85 _I
        dw      FETCH_HIGH_SCORE_ENTRY     ; $DA87 FETCH_HIGH_SCORE_ENTRY
        dw      XT_I                    ; $DA89 _I
        dw      XT_1plus                ; $DA8B _1plus
        dw      STORE_HIGH_SCORE_ENTRY     ; $DA8D STORE_HIGH_SCORE_ENTRY
        dw      XT_I                    ; $DA8F _I
        dw      STORE_HIGH_SCORE_INITIALS     ; $DA91 STORE_HIGH_SCORE_INITIALS
        dw      XT_I                    ; $DA93 _I
        dw      XT_1plus                ; $DA95 _1plus
        dw      LOAD_HIGH_SCORE_INITIALS     ; $DA97 LOAD_HIGH_SCORE_INITIALS
        dw      XT_LIT                  ; $DA99 _LIT
...
LDA9F:
        ...
        dw      HIGH_SCORE_INITIALS_ADDRESS     ; $DAAB HIGH_SCORE_INITIALS_ADDRESS
        ...
        dw      STORE_HIGH_SCORE_ENTRY     ; $DAC5 STORE_HIGH_SCORE_ENTRY
...
; Present the completed game, qualify each active player's double-cell score,
; insert qualifying records into the ten-entry table, and collect three
; initials through the player answer buttons. ( -- )
GAME_OVER_HIGH_SCORE_TASK:
        ...
        dw      FETCH_PLAYER_TWO_SCORE                                                ; $DB4A execution token
        dw      XT_BRANCH                                                       ; $DB4C execution token
        dw      LDB52                                                           ; $DB4E branch target
LDB50:
        dw      FETCH_PLAYER_ONE_SCORE                                                ; $DB50 execution token
LDB52:
        dw      XT_LITbyte                                                      ; $DB52 execution token
        db      $0A                                                             ; $DB54 inline byte
        dw      FETCH_HIGH_SCORE_ENTRY                                                ; $DB55 execution token
        dw      COMPARE_UNSIGNED_SCORE                                                ; $DB57 execution token
        ...
        dw      FETCH_PLAYER_ONE_SCORE                                                ; $DB85 execution token
        dw      INSERT_HIGH_SCORE_ENTRY                                                ; $DB87 execution token
...
LDB9D:
        dw      FETCH_PLAYER_TWO_SCORE                                                ; $DB9D execution token
        dw      INSERT_HIGH_SCORE_ENTRY                                                ; $DB9F execution token
...
LDBFC:
        dw      DRAW_QUALIFYING_PLAYER                                                ; $DBFC execution token
        dw      DRAW_INITIALS_ENTRY_INSTRUCTIONS                                                ; $DBFE execution token
LDC00:
        ...
        dw      FETCH_HIGH_SCORE_ENTRY                                                ; $DC12 execution token
        dw      PREPARE_INITIALS_BUFFER                                                ; $DC14 execution token
        dw      $2083                                                           ; $DC16 execution token
        dw      XT_1                                                            ; $DC18 execution token
        dw      STORE_HIGH_SCORE_INITIALS                                                ; $DC1A execution token
...
LDC3D:
        dw      GET_INITIALS_CHARACTER                                                ; $DC3D execution token
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DC50 execution token
        ...
        dw      INITIALS_CURSOR_AT_LIMIT                                                ; $DC62 execution token
...
LDC6B:
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DC84 execution token
        dw      STORE_HIGH_SCORE_INITIALS                                                ; $DC86 execution token
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DCA7 execution token
        dw      FETCH_HIGH_SCORE_ENTRY                                                ; $DCA9 execution token
        dw      PREPARE_INITIALS_BUFFER                                                ; $DCAB execution token
        dw      $1F72                                                           ; $DCAD execution token
        dw      XT_LITbyte                                                      ; $DCAF execution token
        db      $05                                                             ; $DCB1 inline byte
        dw      INITIALS_CURSOR_AT_LIMIT                                                ; $DCB2 execution token
...
LDD46:
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DD60 execution token
        dw      ADVANCE_INITIALS_CURSOR                                                ; $DD62 execution token
        ...
        dw      DRAW_INITIALS_CURSOR                                                ; $DD74 execution token
...
LDD8E:
        dw      READ_INITIALS_ENTRY_BUTTONS                                                ; $DD8E execution token
        dw      XT_1                                                            ; $DD90 execution token
        dw      XT_OF                                                           ; $DD92 execution token
        dw      LDDB9                                                           ; $DD94 branch target
        dw      GET_INITIALS_CHARACTER                                                ; $DD96 execution token
...
LDDB9:
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DDC0 execution token
...
LDDE3:
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DDF3 execution token
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DE1F execution token
        ...
        dw      ADVANCE_INITIALS_CURSOR                                                ; $DE2C execution token
        ...
        dw      DRAW_INITIALS_CHARACTER                                                ; $DE39 execution token
        dw      $2083                                                           ; $DE3B execution token
LDE3D:
        dw      $15E7                                                           ; $DE3D execution token
        dw      READ_INITIALS_ENTRY_BUTTONS                                                ; $DE3F execution token
...
LDE50:
        dw      GET_INITIALS_CHARACTER                                                ; $DE50 execution token
        ...
        dw      GET_INITIALS_CHARACTER                                                ; $DE6B execution token
        dw      ADVANCE_INITIALS_CURSOR                                                ; $DE6D execution token
...
LDE71:
        ...
        dw      LOAD_HIGH_SCORE_INITIALS                                                ; $DE8D execution token
LDE8F:
...
NORMAL_PLAY_THREAD:
        ...
        dw      CFG1_MAIN_APPLICATION_XT ; $DEC7 MAIN_APPLICATION
        dw      XT_RETURN               ; $DEC9 _RETURN
MAIN_PROGRESSION_ACTIONS:
        db      $01                                                             ; $DECB action count
        dw      CFG1_XT_MAIN_PROGRESSION_TASK                                   ; $DECC action task

MAIN_CONTROL_ACTIONS:
        db      $03                                                             ; $DECE action count
        dw      START_GAME_CONTROL_TASK                                                ; $DECF action task
        dw      ATTRACT_SOUND_TASK                                                ; $DED1 action task
        dw      COIN_CREDIT_CONTROL_TASK                                                ; $DED3 action task

ATTRACT_CHALLENGE_PROMPT_ACTIONS:
        db      $01                                                             ; $DED5 action count
        dw      CFG1_XT_ATTRACT_CHALLENGE_TASK                                  ; $DED6 action task

ATTRACT_DEMO_QUESTION_ACTIONS:
        db      $01                                                             ; $DED8 action count
        dw      CFG1_XT_ATTRACT_DEMO_TASK                                       ; $DED9 action task
GAME_OVER_ACTIONS:
        db      $01                                                             ; $DEDB action count
        dw      GAME_OVER_HIGH_SCORE_TASK                                               ; $DEDC action task

CREDIT_START_PROMPT_ACTIONS:
        db      $01                                                             ; $DEDE action count
        dw      CFG1_XT_CREDIT_START_TASK                                       ; $DEDF action task

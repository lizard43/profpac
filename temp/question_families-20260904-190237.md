...
| Feature | Families |
| --- | ---: |
| random correct slot | 45/45 |
| distinct second slot | 45/45 |
| remaining third slot | 45/45 |
| scene setup | 45/45 |
| action completion | 45/45 |
| child-action join | 45/45 |
| cooperative yield | 45/45 |
| object renderer | 32/45 |
| object draw | 30/45 |
| descriptor draw | 37/45 |
| task-vector animation | 39/45 |

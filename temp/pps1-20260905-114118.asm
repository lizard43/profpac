...
CHECK_SERVICE_SWITCH:
        ...
        bit 2,a                         ; $006F
        jp nz,NORMAL_PLAY_THREAD_ENTRY  ; $0071 test switch released
        ld a,BANK_CONFIG_1              ; $0074
...
WORK_RAM_FILL_BYTE:
        ...
        ld bc,SELF_TEST_THREAD_IP       ; $00E9 test switch active
        jp TERSE_INIT                   ; $00EC
NORMAL_PLAY_THREAD_ENTRY:
        ld bc,NORMAL_PLAY_THREAD_IP     ; $00EF
TERSE_INIT:
...
; Scale the next PRNG value into the unsigned half-open range [0, limit).
; Bucket and variant selectors depend on the result remaining below limit.
; ( limit -- random )
RANDOM_BELOW:

...
ACTION_LISTS = (
    ...
    ActionList(0xDECB, (0xBCDB,), "POST_ROUND_ACTIONS", 1),
    ActionList(0xDECE, (0xD4DF, 0xD489, 0xD430), "ATTRACT_OPEN_ACTIONS", 1),
    ActionList(0xDED5, (0xB6C9,), "ATTRACT_DEMO_ACTIONS", 1),
    ActionList(0xDED8, (0xB4FC,), "ATTRACT_TITLE_ACTIONS", 1),
    ActionList(0xDEDB, (0xDB1B,), "ROUND_RESULT_ACTIONS", 1),
    ActionList(0xDEDE, (0xB8B4,), "ATTRACT_CLOSE_ACTIONS", 1),
)
...
ROOT_NAMES = {
    ...
    0xDB1B: "ROUND_RESULT_TASK",
    0xBCDB: "POST_ROUND_TRANSITION_TASK",
}
...
CROSS_ROM_NAMES = {
    ...
    0xBCDB: "CFG1_XT_POST_ROUND_TRANSITION_TASK",
}
